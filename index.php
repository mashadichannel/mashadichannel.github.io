...
Provider Tri
*/
echo @color("yellow","─────────────────POWERED BY─────────────────────\n");
echo @color("green","                 BIMA +                 \n");
echo @color("yellow","================================================\n");
...
if (strpos(json_encode($login), '"status":true')) {
    ...
    switch ($pilih) {
        ...
        default:
            echo @color('red', "Pilih Paket Dahulu\n\n");
            goto cek;
            break;
    }
    $cek = cek($prodid);
